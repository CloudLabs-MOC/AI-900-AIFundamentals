...
1. Select **Configure + Submit**, and create a new experiment, on the basics page select **Create new** and enter New experiment name as **mslearn-auto-training**  and enter Job display name as **Auto Price Training**.
